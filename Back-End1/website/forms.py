...
class PasswordChangeForm(FlaskForm):
    current_password = PasswordField('Current Paasword', validators=[DataRequired(), Length(min=6)])
    new_password = PasswordField('Current Paasword', validators=[DataRequired(), Length(min=6)])
    confirm_new_password = PasswordField('Current Paasword', validators=[DataRequired(), Length(min=6)])
